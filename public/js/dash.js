...
fetchUltimas();
    ...
    /* Highcharts.chart("containerTreemap", {
        ...
        series: [
        {
            ...
            data: [
            {
                name: String(nomeBairros.bairros[0]),
                value: parseFloat(nomeBairros.valores[0]),
                color: "#fa0f0f",
            },
            {
                name: String(nomeBairros.bairros[1]),
                value: parseFloat(nomeBairros.valores[1]),
                color: "#FF4500",
            },
            {
                name: String(nomeBairros.bairros[2]),
                value: parseFloat(nomeBairros.valores[2]),
                color: "#ff7700",
            },
            {
                name: String(nomeBairros.bairros[3]),
                value: parseFloat(nomeBairros.valores[3]),
                color: "#FFA500",
            },
            {
                name: String(nomeBairros.bairros[4]),
                value: parseFloat(nomeBairros.valores[4]),
                color: "#FFFF00",
            },
            ],
        },
        ...
        title: {
        text: "Bairros com mais registros de crimes",
        },
        tooltip: {
        headerFormat: "",
        pointFormat: "<b>{point.name}</b>: {point.value} crimes",
        },
        plotOptions: {
        treemap: {
            borderWidth: 1,
